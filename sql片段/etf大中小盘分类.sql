WITH IndexClassification AS (
    SELECT 
        internal_id,
        CASE
            WHEN fund_fullname SIMILAR TO '%(国证2000指数|中证1000|中证2000|中证500|中小板300指数|上证380|上证中小|创业板指)%' THEN '小盘'
            WHEN fund_fullname SIMILAR TO '%(国证1000指数|中证800|中证200|上证中盘|中小板指|深证300价格|深证成份指数)%' THEN '中盘'
