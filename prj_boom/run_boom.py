...
def process_industry(industry, stationary, base_config, financial_list):
    ...
    for financial in financial_list:
        ...
        end_date = '2024-04-30'
        contribution_text = f"Variable contributions to factor change from {start_date} to {end_date} for {industry} (stationary={stationary}, financial={financial}):\n"
...
for result in all_results:
    document.add_heading(f"{result['industry']} (stationary={result['stationary']}, financial={result['financial']})", level=1)
